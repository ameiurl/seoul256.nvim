local colors = {
	...
	c89 = "#9B1D72",
	c94 = "#9A7200",
	c95 = "#9A7372", --DiffDelete PmenuSel StatusLine StatusLineTerm [red] - original is worse not as bad as green
	c96 = "#9A7599",
	...
	c187 = "#DFDEBD", --Function Directory StatusLine StatusLineTerm StatusLineNc StatusLineTermNc [blue]
	c189 = "#DFDFFF",
	c216 = "#FFBD98", --Special
	...
	c237 = "#4B4B4B", --background default Ignore [bg]
	c238 = "#565656", --background Folded FoldColumn Pmenu IncSearch [bg_alt?]
	c239 = "#616161", --background-lightest StatusLineNc StatusLineTermNc (light)
	c240 = "#6B6B6B", --DiffChange Matchparen Ignore -> (bg + 3)
	c241 = "#757575",
	c249 = "#BFBFBF",
	c250 = "#C8C8C8",
	c251 = "#D1D0D1",
	c252 = "#D9D9D9", --background-light-darkest Pmenu PmenuSel Error ErrorMsg Search (dark_fg) [fg]
